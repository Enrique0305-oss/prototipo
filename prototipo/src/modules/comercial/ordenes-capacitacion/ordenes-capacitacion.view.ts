          ...
          <div class="oc-section">
            ...
            <div class="oc-grid">
              ...
              <div class="oc-field">
                ...
                <input type="date" id="oc-fecha-aceptacion" class="oc-input" disabled>
              </div>
              <div class="oc-field">
...
async function cargarDatosCotizacion(cotizacionId: number) {
  try {
    ...
    // Auto-llenar fecha aceptación con fecha de estado de la cotización (fallback: fecha de emisión)
    (document.getElementById('oc-fecha-aceptacion') as HTMLInputElement).value = toDateInput(
      data.cotizacion?.fecha_aceptacion || data.cotizacion?.fecha_emision,
    );
