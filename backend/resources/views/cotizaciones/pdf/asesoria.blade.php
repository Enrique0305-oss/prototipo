...
@include('cotizaciones.pdf.partials.styles-capacitacion')
        ...
        .miniword-content table {
            width: 100% !important;
            table-layout: fixed;
            border-collapse: collapse;
        }

        .miniword-content img {
                    ...
                    <span class="highlight-service">
                        @php
                            ...
                            if ($cantidad > 2) {
                                ...
                                $textoMostrar = "Plan de Asesorías";
                            } else {
        ...
        <div class="contenido-desplazado">
            ...
            <div class="payment-section">
                ...
                <ul>
                    ...
                    <li style="font-size: 13px; margin-bottom: 5px;">Crédito 30 días, luego de haber sido realizada la Asesoría.</li>
                </ul>
