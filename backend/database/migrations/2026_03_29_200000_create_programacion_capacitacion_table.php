...
return new class extends Migration
{
    ...
    {
        Schema::create('programacion_capacitacion', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index(['id_orden_capacitacion', 'fecha_programada'], 'idx_prog_cap_orden_fecha');
        });
    }
    ...
    {
        Schema::dropIfExists('programacion_capacitacion');
    }
};
